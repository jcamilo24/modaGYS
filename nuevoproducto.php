...
<script type="text/javascript">
  ...
  <head>
    ...
    <link rel="stylesheet" href="css/estilos_new_producto.css">
  </head>
  <body>
    <header>
      <div class="titulo_producto">
        <p>Nuevo Producto</p>
        <img style=" margin:10px;" src="recursos/iconos/anadir.png" alt="" width="50" height="50" >
      </div>
    </header>
    <div class="main" >
        <form class="new_producto" action="agregar_new_producto.php" method="post">
          <div class="Tabla_producto">
            ...
            <div class="txb_datos">
              <p><input type="text" name='id_producto' required></p></br>
              <p><input type="text" name='nombre_producto' required autocomplete="off"> </p></br>
              <p><input type="text" name='cantidad' required autocomplete="off"> </p></br>
              <p><input type="tex" name='valor_venta' required autocomplete="off"> </p></br>
              <p><input type="file" name='foto' ></p></br>
            </div>
          </div>
          <div class="Tabla_categoria">
            <div class="lbl_datos">
              <p>Id Categoria (A.I)</p></br>
              <p>Nombre Categoria *</p></br>
            </div>
            <div class="txb_datos">
              <p><input type="text" disabled></p></br>
              <p><input type="text" name='nombre_categoria' required autocomplete="off"></p></br>
          ...
          <div class="Tabla_marca">
            ...
            <div class="txb_datos">
              <p><input type="text" disabled></p></br>
              <p><input type="text" name='nombre_marca' required autocomplete="off"></p></br>
